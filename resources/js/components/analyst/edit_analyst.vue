      ...
      <div class="col-lg-12">
        <div class="table-responsive-lg">
          ...
          >
            ...
            // Solids
            <Column  header="Ag, Dore(Mg)" :hidden="this.form.transType != 'Solids'"> <template #body>{{ this.form.transType }}</template> </Column>
            <Column  header="For Inquart(Mg)" :hidden="this.form.transType != 'Solids'"> <template #body>{{ this.form.transType }}</template> </Column>
            <Column  header="Au, Prill(Mg)" :hidden="this.form.transType != 'Solids'"> <template #body>{{ this.form.transType }}</template> </Column>
            <Column  header="Au, (Gpt)" :hidden="this.form.transType != 'Solids'"> <template #body>{{ this.form.transType }}</template> </Column>
            <Column  header="Crusible Clearance" :hidden="this.form.transType != 'Solids'"> <template #body>{{ this.form.transType }}</template> </Column>
            <Column  header="Remarks" :hidden="this.form.transType != 'Solids'"> <template #body>{{ this.form.transType }}</template> </Column>
             <Column
              :exportable="false"
              style="min-width: 8rem"
              header="Actions"
